...
export function WishlistPage() {
  ...
  const [statDetail, setStatDetail] = useState<"cities" | "countries" | null>(
    null,
  );
    ...
    <div className="page page-wishlist">
      ...
      <section className="stats-panel" aria-label={t("stats.title")}>
        <div className="stats-panel-header">
          ...
          <small>
            {stats.totalPins} {t("stats.memories")}
          </small>
        </div>
        <div className="stat-grid">
          ...
          <button
            type="button"
            className="stat-card stat-card-purple clickable"
      ...
      {statDetail &&
        createPortal(
          ...
          >
            <div
              className="stat-detail-sheet wish-stat-detail-sheet"
                ...
                {dreams.map((b) => (
                  <div key={b.id} className="wish-card">
                    ...
                    <div className="wish-body">
                      <div className="wish-card-kicker">
                        {t("wish.dreaming")}
                      </div>
