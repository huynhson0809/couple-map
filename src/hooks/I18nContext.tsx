...
const dict = {
  en: {
    ...
    "notif.reactionsHint": "When your partner reacts to your memory or comment",
    "notif.comments": "Comments",
    "notif.commentsHint": "When your partner comments or replies",
    ...
    "landing.heroAccent": "for both of you",
    "landing.heroBadge": "For couples who love memories",
    "landing.heroDesc":
      "Pin every moment together on your private map. From your first café to your farthest trip — every memory has a place.",
    "landing.ctaPrimary": "Create your map for free",
    "landing.ctaInstall": "Install app",
    "landing.ctaLearnMore": "Learn more",
    "landing.login": "Log in",
    "landing.getStarted": "Get started",
    "landing.mockupTagline": "Your love, on the map",
    "landing.proofPrivate": "Private",
    "landing.proofPwa": "Works offline",
    "landing.proofFree": "Free to start",
    "landing.proofCouples": "1K+ couples using Pinly",
    "landing.langSwitch": "Tiếng Việt",
    "landing.featuresTitle": "Everything you need",
    "landing.feat1Title": "Memory map",
    "landing.feat1Desc": "Pin every moment on your couple's private map.",
    ...
    "landing.feat3Desc": "Both save daily to keep the streak going.",
    "landing.feat4Title": "Interactions",
    "landing.feat4Desc": "React, comment, nudge when your partner forgets.",
    "landing.feat5Title": "Private",
    "landing.feat5Desc": "Only you two can see. No ads, no third parties.",
    ...
    "landing.step1": "Create an account & enter your partner's invite code",
    "landing.step2": "Pin your first memory on the map",
    "landing.step3": "Save together daily — build your love map",
    ...
    "landing.bottomCtaDesc": "Free. No credit card. Just love 💕",
  ...
  vi: {
    ...
    "notif.reactionsHint":
      "Khi người ấy bày tỏ cảm xúc với kỷ niệm hoặc bình luận của bạn",
    "notif.comments": "Bình luận",
    "notif.commentsHint": "Khi người ấy bình luận hoặc trả lời bình luận",
    ...
    "landing.heroAccent": "của hai bạn",
    "landing.heroBadge": "Dành cho những cặp đôi yêu kỷ niệm",
    "landing.heroDesc":
      "Ghim mỗi khoảnh khắc bên nhau lên bản đồ riêng. Từ quán quen đến chuyến đi xa — mỗi kỷ niệm đều có chỗ.",
    ...
    "landing.feat3Desc": "Cả hai cùng lưu mỗi ngày để giữ streak liên tục.",
    "landing.feat4Title": "Tương tác",
    "landing.feat4Desc": "Thả tim, bình luận, nhắc nhẹ khi đối phương quên.",
    "landing.feat5Title": "Riêng tư",
    "landing.feat5Desc": "Chỉ hai bạn thấy. Không quảng cáo, không bên thứ ba.",
    ...
    "landing.step1": "Tạo tài khoản & nhập mã mời đối phương",
    "landing.step2": "Ghim kỷ niệm đầu tiên lên bản đồ",
    "landing.step3": "Cùng lưu mỗi ngày — xây bản đồ tình yêu",
    ...
    "landing.bottomCtaDesc": "Miễn phí. Không cần thẻ. Chỉ cần tình yêu 💕",
