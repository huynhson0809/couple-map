...
const dict = {
  en: {
    ...
    "landing.heroTitle": "Memory map",
    "landing.heroAccent": "for every memory",
    "landing.heroBadge": "For personal and shared memories",
    "landing.heroDesc":
      "Pin meaningful moments on your private map. From a favorite café to a faraway trip — every memory has a place.",
    "landing.ctaPrimary": "Create your map for free",
    "landing.ctaInstall": "Install app",
    "landing.ctaLearnMore": "Learn more",
    "landing.login": "Log in",
    "landing.getStarted": "Get started",
    "landing.mockupTagline": "Your memories, on the map",
    "landing.proofPrivate": "Private",
    "landing.proofPwa": "Works offline",
    "landing.proofFree": "Free to start",
    "landing.proofCouples": "1K+ memory maps created",
    "landing.langSwitch": "Tiếng Việt",
    "landing.featuresTitle": "Everything you need",
    "landing.feat1Title": "Memory map",
    "landing.feat1Desc": "Pin every moment on a private memory map.",
    "landing.feat2Title": "Photos & Videos",
    "landing.feat2Desc": "Attach photos, videos and revisit your timeline.",
    "landing.feat3Title": "Memory streak",
    "landing.feat3Desc": "Save daily moments to keep the streak going.",
    "landing.feat4Title": "Interactions",
    "landing.feat4Desc": "React, comment, and nudge other members.",
    "landing.feat5Title": "Private",
    "landing.feat5Desc": "Only invited members can see. No ads, no third parties.",
    ...
    "landing.step1": "Create an account or join with an invite code",
    "landing.step2": "Pin your first memory on the map",
    "landing.step3": "Save daily moments and grow your memory map",
    ...
    "landing.bottomCtaTitle": "Start saving memories today",
    "landing.bottomCtaDesc": "Free. No credit card. Just memories.",
  ...
  vi: {
    ...
    "landing.heroTitle": "Bản đồ kỷ niệm",
    "landing.heroAccent": "cho mọi kỷ niệm",
    "landing.heroBadge": "Cho kỷ niệm cá nhân và chia sẻ",
    "landing.heroDesc":
      "Ghim những khoảnh khắc đáng nhớ lên bản đồ riêng. Từ quán quen đến chuyến đi xa — mỗi kỷ niệm đều có chỗ.",
    "landing.ctaPrimary": "Tạo bản đồ miễn phí",
    "landing.ctaInstall": "Cài ứng dụng",
    "landing.ctaLearnMore": "Tìm hiểu thêm",
    "landing.login": "Đăng nhập",
    "landing.getStarted": "Bắt đầu",
    "landing.mockupTagline": "Kỷ niệm của bạn, trên bản đồ",
    "landing.proofPrivate": "Riêng tư",
    "landing.proofPwa": "Dùng offline",
    "landing.proofFree": "Miễn phí",
    "landing.proofCouples": "1K+ bản đồ kỷ niệm đã tạo",
    "landing.langSwitch": "English",
    "landing.featuresTitle": "Mọi thứ bạn cần",
    "landing.feat1Title": "Bản đồ kỷ niệm",
    "landing.feat1Desc": "Ghim mỗi khoảnh khắc lên bản đồ kỷ niệm riêng.",
    "landing.feat2Title": "Ảnh & Video",
    "landing.feat2Desc": "Đính kèm ảnh, video và xem lại timeline hành trình.",
    "landing.feat3Title": "Chuỗi kỷ niệm",
    "landing.feat3Desc": "Lưu mỗi ngày để giữ streak liên tục.",
    "landing.feat4Title": "Tương tác",
    "landing.feat4Desc": "Thả tim, bình luận, nhắc nhẹ các thành viên khác.",
    "landing.feat5Title": "Riêng tư",
    "landing.feat5Desc":
      "Chỉ thành viên được mời thấy. Không quảng cáo, không bên thứ ba.",
    ...
    "landing.step1": "Tạo tài khoản hoặc nhập mã mời",
    "landing.step2": "Ghim kỷ niệm đầu tiên lên bản đồ",
    "landing.step3": "Lưu mỗi ngày và xây bản đồ kỷ niệm",
    ...
    "landing.bottomCtaTitle": "Bắt đầu lưu giữ kỷ niệm ngay hôm nay",
    "landing.bottomCtaDesc": "Miễn phí. Không cần thẻ. Chỉ cần kỷ niệm.",
